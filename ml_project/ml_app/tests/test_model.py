    ...
    def setUp(self):
        self.image = Image.objects.create(
            image = SimpleUploadedFile(
                name = "test_image.jpg",
                content = open(os.path.join(settings.BASE_DIR, "ml_app", "tests", "test_assets", "test_images", "bike_rider.jpg"), 'rb').read(),
                content_type = 'image/jpg'
            ),
            video = SimpleUploadedFile(
                name = "test_video.mp4",
                content = open(os.path.join(settings.BASE_DIR, "ml_app", "tests", "test_assets", "test_videos", 'he2.mp4'), 'rb').read(),
